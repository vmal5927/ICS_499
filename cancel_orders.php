<?php
	...
	$query = "SELECT ol.item_id, `item_name`, `brand`, `model`, o.order_id, `quantity`, `customer_id`, `date`, `approval_status`, `delivery_status` FROM `order_lines` ol, `orders` o, `inventory` i WHERE ol.order_id = o.order_id AND customer_id = '$user_id' AND ol.item_id = i.item_id AND `delivery_status` <> '1'";
    ...
    <div class="container">
        ...
        <div class="card my-5">
            <div class="card-header">
                <h1 class="text-center m-4">Cancel Orders</h1>
            </div>
            <div class="card-body">
                            ...
                            // output data of each row
                         	while($row = $result->fetch_assoc()) {
								...
								echo    '<tr>
											...
											<td><a href="cancel_order_process.php?id='.$row["order_id"].'"><input
										 	  class="btn btn-danger" type="button" value="Cancel Order"></a></td>
                                        </tr>';
