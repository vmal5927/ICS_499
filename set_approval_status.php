<?php
	...
	if(isset($_GET['id'])){
		$order_id = $_GET['id'];
		mark_as_approved();
		header("Location: set_approval_status.php");
	}
   
	function mark_as_approved(){
		global $db, $order_id;
...
<head>
    ...
    <title>Set Approval Status</title>
</head>
    ...
    <div class="container">
        ...
        <div class="card my-5">
            <div class="card-header">
                <h1 class="text-center m-4">Set Orders Approval Status</h1>
            </div>
            <div class="card-body">
                            ...
                            // output data of each row
                         	while($row = $result->fetch_assoc()) {
								...
								echo    '<tr>
											...
											<td><a href="set_approval_status.php?id='.$row["order_id"].'"><input
										 	  class="btn btn-warning" type="button" value="Approve Order"></a></td>
                                        </tr>';
